"""
Structured logging configuration for the PI-GAN pipeline.
...
def setup_logger(
    ...
    # Wrap stdout in a UTF-8 stream so Unicode characters (│) in the
    # format string don't crash on Windows cp1252 consoles.
    import io
...
def get_logger(name: str = "pigan") -> logging.Logger:
